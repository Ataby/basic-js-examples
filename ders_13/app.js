...
// }
// console.log(getInfo()); // FONK. RETURN DEĞERI SABIT BIR DEGER OLDUGU ICIN PARAMETRE EKLENSE DAHI AYNI SONUCU VERIR.

// const  {model,battery} = getInfo(); //IKI PARAMETRESI DESTRUCTURE YAPILDI
...
//calc({model:'Samsung S23+',storage:'256GB'});
//DESTRUCTURE YAPILMAMIŞ BIR OBJECT DONDURULEMEZ.
...
// const [k4,,k3,,k2] = names; //DESTRUCTURE'DA ARRAY'DEN INDIS SIRASINA GORE  ELEMAN ALINIR.
// console.log(k2,k3,k4); // BIR FONKSIYON ICINDE DEĞIŞIK TIPLERDE ELEMANLARI OLAN BIR ARRAY DONDUREBILIR (OBJECT,VALUE,BOOLEAN). ARRAY DONDUREN BIR FONKSIYONDAN ISTENILEN VERILER BU TIPLE ALINIR.
